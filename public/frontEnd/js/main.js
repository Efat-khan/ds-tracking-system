...
const addTaskWorkBtn = document.getElementById("add-task-work-btn");
const setTaskWork = document.getElementById("set-task-work");
...
// add task work
addTaskWorkBtn.addEventListener("click", () => {
  setTaskWork.classList.remove("hide");
  activeOverlay = setTaskWork;
  // disable scrolling for content behind the overlay
  document.body.classList.add("overflow-hidden");
});
