...
class DailySummaryDetailsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $daily_summary->total_estimated_time += $request->estimated_time ?? 0;
        $daily_summary->total_spent_time += $request->spent_time ?? 0;
        $daily_summary->total_learning_time += $request->learning_time ?? 0;
        $daily_summary->save();
    ...
    public function delete($id){
        ...
        $daily_summary->total_estimated_time -= $task->estimated_time ?? 0;
        $daily_summary->total_spent_time -= $task->spent_time ?? 0;
        $daily_summary->total_learning_time -= $task->learning_time  ?? 0;
        $daily_summary->save();
        $task->delete();
